...
public class Node {
	...
	public Node (InetSocketAddress address) {
		...
		System.out.println("LOCALIDDDD: = " + localId);
	...
	public boolean join (InetSocketAddress contact) {
		...
		// this is true only when there already exist some node before
		// contact has already existing node.
		// localAddress has newly created node
